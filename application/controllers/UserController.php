...
class UserController extends Zend_Controller_Action
{
    ...
    public function createAction()
    {
		...
		$userForm->setAction(APPLICATION_URL.'/public/user/create');
    ...
    public function updateAction()
    {
        // action body
		$userForm = new Form_User();
		$userForm->setAction(APPLICATION_URL.'/public/user/update');
    ...
    public function passwordAction()
    {
		...
		$passwordForm->setAction(APPLICATION_URL.'/public/user/password');
    ...
    public function loginAction()
    {
        // action body
		$userForm = new Form_User();
		$userForm->setAction(APPLICATION_URL.'/public/user/login');
